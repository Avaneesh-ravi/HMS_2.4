...
<div class="container d-flex align-items-center justify-content-center" style="min-height: 80vh;">
  <div class="card-soft text-center position-relative" style="width: 100%; max-width: 500px; padding: 50px 40px; border-left: none;">
    ...
    <div style="position: relative; z-index: 1;">
        ...
        <a href="feedback-form.php" class="btn btn-teal btn-lg d-inline-flex align-items-center justify-content-center" style="padding: 14px 24px; font-size: 1.05rem;" onclick="clearDraft()">
